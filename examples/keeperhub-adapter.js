...
const keeperHubAdapter_1 = require("../src/keeperHubAdapter");
/**
 * Example: Using the KeeperHub Adapter for workflow integration
 */
async function exampleKeeperHubAdapter() {
    const adapter = new keeperHubAdapter_1.MatchaKeeperHubAdapter({
        chainId: 1,
    });
...
//# sourceMappingURL=keeperhub-adapter.js.map